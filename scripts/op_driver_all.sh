...
${OP_DRIVER_DIR}/op_driver conv -f 1 -p 1 -s 1 -d 2  -x 3  -k 32 -w 128 -h 128 -c 32 -g 32
...
${OP_DRIVER_DIR}/op_driver conv -f 1 -p 0 -s 1 -d 2  -x 1  -k 32 -w 128 -h 128 -c 32 -g 32
